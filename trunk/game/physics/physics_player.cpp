 ...
 * $Source$
 * $Revision: 1500 $
 * $Date: 2007-10-20 23:59:22 -0400 (Sat, 20 Oct 2007) $
 * $Author: ishtvan $
 *
 * $Log$
...
static bool init_version = FileVersionList("$Source$  $Revision: 1500 $   $Date: 2007-10-20 23:59:22 -0400 (Sat, 20 Oct 2007) $", init_version);
...
{
	idVec3	wishdir, wishvel, right, ropePoint, offset, newOrigin, ClimbAxis;
...
void idPhysics_Player::SetRefEntVel( idEntity *ent, int bodID)
{
	...
	else
	{
		...
		// TODO: Support climbable AFs (besides ropes) by also storing the AF body climbed on?
