...
idCVar cv_moveable_collision("tdm_show_moveable_collision",	"1.0",	CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "If set to 1, shows the velocity at which the moveable collides and the volume of the resulting sound." );
