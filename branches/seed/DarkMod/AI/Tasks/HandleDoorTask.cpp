 ...
 * $Revision: 4693 $
 * $Date: 2011-03-17 09:58:18 -0400 (Thu, 17 Mar 2011) $
 * $Author: grayman $
 *
 ***************************************************************************/
...
static bool init_version = FileVersionList("$Id: HandleDoorTask.cpp 4693 2011-03-17 13:58:18Z grayman $", init_version);
	...
	if (!frobDoor->IsOpen())
	{
		switch (_doorHandlingState)
		{
			...
			case EStateMovingToFrontPos:
			{
				...
				if (owner->ReachedPos(_frontPos, MOVE_TO_POSITION) || ((owner->GetTactileEntity() != NULL) && (closedPos - owner->GetPhysics()->GetOrigin()).LengthFast() < 100)) // grayman #2345
				{
