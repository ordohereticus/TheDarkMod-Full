 ...
 * $Revision: 2523 $
 * $Date: 2008-06-19 00:54:20 -0400 (Thu, 19 Jun 2008) $
 * $Author: greebo $
 *
 ***************************************************************************/
...
static bool init_version = FileVersionList("$Id: FrobDoor.cpp 2523 2008-06-19 04:54:20Z greebo $", init_version);
...
void CFrobDoor::PostSpawn()
{
	...
	if (!m_MasterLock.IsEmpty())
	{
		...
		{
			DM_LOG(LC_SYSTEM, LT_ERROR)LOGSTRING("master_lock [%s] not spawned\r", m_MasterLock.c_str());
		}
	}
