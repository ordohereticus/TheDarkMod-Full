 ...
 * $Revision: 4268 $
 * $Date: 2010-10-31 14:36:24 -0400 (Sun, 31 Oct 2010) $
 * $Author: newhorizon $
 *
 ***************************************************************************/
...
static bool init_version = FileVersionList("$Id: syscvar.cpp 4268 2010-10-31 18:36:24Z newhorizon $", init_version);
...
idCVar r_postprocess_colorCurveBias			( "r_postprocess_colorCurveBias",		"0.54",		CVAR_GAME | CVAR_FLOAT,		" Applies Exponential Color Curve to final pass (range 0 to 1), 1 = color curve fully applied , 0= No color curve");
idCVar r_postprocess_colorCorrection		( "r_postprocess_colorCorrection",		"1.15",		CVAR_GAME | CVAR_FLOAT,		" Applies an exponential color correction function to final scene ");
