 ...
 *
 * $Log$
 * Revision 1.1  2004/10/30 15:52:27  sparhawk
 * Initial revision
 *
 ***************************************************************************/
...
//Name: fire2.ma
//Last modified: Tue, Mar 18, 2003 09:48:02 PM
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 48.55657198559738 -5.8922814650052739 -37.756445991293525 ;
	setAttr ".r" -type "double3" 3.8698910864171099 141.80000000001019 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 100000;
	setAttr ".coi" 52.393148804977386;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.388888888888889 100 -2.0370370370370363 ;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.9968092346807929 -7.9161166149004849 102.68062202911365 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fcp" 100000;
	setAttr ".coi" 100;
	setAttr ".ow" 43.041214797784804;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100 -12.937311324223494 1.3798468301195268 ;
...
createNode animCurveTL -n "MGUN_Rloarm_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 4.2019356114500193 4 5.5895682500307444;
createNode animCurveTL -n "MGUN_Rloarm_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -21.710493028270307 4 -21.710493028270307;
createNode animCurveTL -n "MGUN_Rloarm_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 7.4235377027335581 4 6.647843850981447;
createNode animCurveTA -n "MGUN_Rloarm_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 23.858970583210471 4 23.858970583210471;
createNode animCurveTA -n "MGUN_Rloarm_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -12.978384796886047 4 -12.978384796886047;
createNode animCurveTA -n "MGUN_Rloarm_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1.3183589787639254 4 1.3183589787639254;
...
createNode animCurveTA -n "MGUN_Hand_Const_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -37.831895252873686 2 -37.861167973794544 
		4 -37.043136527093303;
createNode animCurveTA -n "MGUN_Hand_Const_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 26.307224381545861 2 25.735615431591235 
		4 24.119371109172484;
createNode animCurveTA -n "MGUN_Hand_Const_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -81.242952009061852 2 -71.994733163055528 
...
createNode animCurveTL -n "MGUN_Luparm_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.45719176638888864;
...
createNode animCurveTL -n "MGUN_Luparm_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -5.1089918048604277;
createNode animCurveTA -n "MGUN_Luparm_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 64.44173526533929;
createNode animCurveTA -n "MGUN_Luparm_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 44.061048311662518;
createNode animCurveTA -n "MGUN_Luparm_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 24.253189311299412;
...
createNode animCurveTL -n "MGUN_joint1_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -0.070703674570827532 4 0.0030757617605206896;
createNode animCurveTL -n "MGUN_joint1_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 4.845752076924529 4 0.24257600657262612;
createNode animCurveTL -n "MGUN_joint1_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 11.605970582134564 4 0.36900809501673359;
...
createNode animCurveTL -n "MGUN_joint2_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0.059530418011483857 4 0.045986124966383178;
createNode animCurveTL -n "MGUN_joint2_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -11.455658667742219 4 -0.22981886370766613;
createNode animCurveTL -n "MGUN_joint2_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 2.7668868133460265 4 0.44706418900463252;
...
createNode animCurveTL -n "MGUN_joint3_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0.053813907473742872 4 0.045986124966383025;
createNode animCurveTL -n "MGUN_joint3_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 13.129464698328491 4 0.11030631194291995;
createNode animCurveTL -n "MGUN_joint3_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -7.2291009970500948 4 -0.63670003593960889;
...
createNode animCurveTL -n "MGUN_joint4_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0.1103046117805077 4 0.045986124966382824;
createNode animCurveTL -n "MGUN_joint4_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -4.3741213708862254 4 -0.43689648867938491;
createNode animCurveTL -n "MGUN_joint4_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -9.5947393651247594 4 -0.71095561219968895;
