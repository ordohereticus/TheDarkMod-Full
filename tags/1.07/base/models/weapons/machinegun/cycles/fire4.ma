...
//Name: fire4.ma
//Last modified: Tue, Mar 18, 2003 09:48:20 PM
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.2404241604021351 -1.1462762343260406 -13.097207142027163 ;
	setAttr ".r" -type "double3" -11.730108913557695 233.79999999997244 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 100000;
	setAttr ".coi" 22.503023608347082;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.233540072825107 -5.9122880141337157 102.68062202911365 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fcp" 100000;
	setAttr ".coi" 100;
	setAttr ".ow" 21.168914300270764;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.22953762964947 -6.1167054649890513 2.8282526646157446 ;
...
createNode animCurveTL -n "MGUN_Rloarm_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 4.5574157893921452 4 5.1154134140104386;
...
createNode animCurveTL -n "MGUN_Rloarm_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 7.2248224370480481 4 6.9128988668793641;
...
createNode animCurveTA -n "MGUN_Hand_Const_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -37.608163408585355 4 -37.043136527093303;
createNode animCurveTA -n "MGUN_Hand_Const_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 22.319551010407952 4 24.119371109172484;
createNode animCurveTA -n "MGUN_Hand_Const_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -80.85420450705162 4 -79.391828382450555;
...
createNode animCurveTL -n "MGUN_Luparm_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.37809955776404236;
...
createNode animCurveTL -n "MGUN_Luparm_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -6.7423962534162056;
createNode animCurveTA -n "MGUN_Luparm_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 65.64383688415144;
createNode animCurveTA -n "MGUN_Luparm_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 41.962368696912925;
createNode animCurveTA -n "MGUN_Luparm_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 37.412640127621593;
...
createNode animCurveTL -n "MGUN_joint1_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0.045986124966383102 4 0.045986124966383102;
createNode animCurveTL -n "MGUN_joint1_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 8.2294419703323385 4 0.3909692657448427;
createNode animCurveTL -n "MGUN_joint1_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0.27431353349647036 4 0.25178630067329033;
...
createNode animCurveTL -n "MGUN_joint3_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -0.017396468495705975 4 0.26962680416585272;
createNode animCurveTL -n "MGUN_joint3_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -13.506024190761492 4 -0.55797549898230114;
...
createNode animCurveTL -n "MGUN_joint2_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1.8003262986714841 4 -0.095308675435210155;
createNode animCurveTL -n "MGUN_joint2_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 10.061878174371918 4 0.21579730773632555;
...
createNode animCurveTL -n "MGUN_joint4_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0.045986124966397313 4 0.045986124966383102;
createNode animCurveTL -n "MGUN_joint4_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -10.844218457528665 4 -0.33035972280181802;
createNode animCurveTL -n "MGUN_joint4_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -0.65854425425226548 4 -0.70970447922618174;
