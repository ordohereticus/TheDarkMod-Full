...
//Name: turret_idle.ma
//Last modified: Mon, Mar 15, 2004 08:21:55 PM
...
createNode transform -s -n "persp";
	setAttr ".t" -type "double3" 230.61814638947922 54.115398616019434 -1.4041515691882864 ;
	setAttr ".r" -type "double3" -5.1301089123321155 -1352.9999999999063 7.5964855471413784e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 100000;
	setAttr ".coi" 202.68879302662407;
...
createNode animCurveTU -n "IMP_Body2_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 1 8.2 1 12.2 1 13 1;
createNode animCurveTL -n "IMP_Body2_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 8.2 -5.4967884695878091 12.2 
		-4.3988027625426138 13 -4.1657930308134645;
createNode animCurveTL -n "IMP_Body2_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 8.2 0.71645197165077801 12.2 
		0.57334040222998173 13 0.54296989172209287;
createNode animCurveTL -n "IMP_Body2_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 8.2 0 12.2 0 13 0;
...
createNode animCurveTA -n "IMP_Body2_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 8.2 -10.396661074269078 12.2 
		-8.1851317596830349 13 -7.4542171015494922;
...
createNode animCurveTU -n "IMP_Waist_scaleX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 8.2 1 13 1;
...
createNode animCurveTL -n "IMP_Waist_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 2.3128351505039433 8.2 2.3128351505039433 
		13 2.3128351505039433;
createNode animCurveTL -n "IMP_Waist_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0.23421866920666501 8.2 0.23421866920666501 
		13 0.23421866920666501;
createNode animCurveTL -n "IMP_Waist_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 8.2 0 13 0;
createNode animCurveTA -n "IMP_Waist_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 2.4125540166489063 8.2 7.8247378664801399 
		13 8.7951795972581372;
createNode animCurveTA -n "IMP_Waist_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 12.660431799163181 8.2 13.751352433260992 
		13 13.892774724407374;
createNode animCurveTA -n "IMP_Waist_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 8.2 22.776694843251629 13 26.888910802325626;
...
createNode animCurveTU -n "IMP_Chest_scaleX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 6.6 1 13 1;
...
createNode animCurveTA -n "IMP_Chest_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 397.48811046169101 6.6 384.076758854052 
		13 389.49637174592857;
createNode animCurveTA -n "IMP_Chest_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -14.641906192173103 6.6 -14.641906192173096 
		13 -14.641906192173099;
createNode animCurveTA -n "IMP_Chest_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -0.44667534838541134 6.6 -0.44667534838541262 
		13 -0.44667534838541167;
createNode animCurveTL -n "IMP_Chest_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 5.6268319407172029 6.6 5.6268319407172029 
		13 5.6268319407172029;
createNode animCurveTL -n "IMP_Chest_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -2.1098668596606802 6.6 -2.1098668596606802 
		13 -2.1098668596606802;
createNode animCurveTL -n "IMP_Chest_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 6.6 0 13 0;
...
createNode animCurveTU -n "IMP_Neck_scaleX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 9.8000000000000007 1 13 1;
...
createNode animCurveTL -n "IMP_Neck_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 5.7384771804188404 9.8000000000000007 
		5.7384771804188404 13 5.7384771804188404;
createNode animCurveTL -n "IMP_Neck_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 2.0494561358638701 9.8000000000000007 
		2.0494561358638701 13 2.0494561358638701;
createNode animCurveTL -n "IMP_Neck_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 9.8000000000000007 0 13 0;
createNode animCurveTA -n "IMP_Neck_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 25.421275224154744 9.8000000000000007 
		36.348615312237058 13 37.874152024707215;
createNode animCurveTA -n "IMP_Neck_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 3.384380797852069 9.8000000000000007 
		-12.486888359019849 13 -14.364226384227051;
createNode animCurveTA -n "IMP_Neck_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -30.586767920152276 9.8000000000000007 
		-36.216831783693365 13 -36.863333637497242;
...
createNode animCurveTU -n "IMP_Head_scaleX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  1 1 6.6 1 11.4 1 13 1 16 1 27 1 
		33 1 39 1 47 1 52 1;
...
createNode animCurveTA -n "IMP_Head_rotateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  1 -26.189308995653338 6.6 -20.615640870158749 
		11.4 -15.091352590275797 13 -8.7397788191085439 16 -8.7397788191085439 27 
		-13.386984648111072 33 -13.386984648111072 39 -7.4300613492731964 47 -8.7397788191085439 
		52 -8.7397788191085439;
	setAttr -s 10 ".kit[3:9]"  3 9 9 9 9 9 9;
	setAttr -s 10 ".kot[3:9]"  3 9 9 9 9 9 9;
createNode animCurveTA -n "IMP_Head_rotateY";
	...
	setAttr -s 10 ".ktv[0:9]"  1 3.5665765693897113 6.6 5.3542358202902411 
		11.4 5.460283656526725 13 7.3330119448673576 16 7.3330119448673576 27 9.1309964717567684 
		33 9.1309964717567684 39 4.1890579402584791 47 7.3330119448673576 52 7.3330119448673576;
	setAttr -s 10 ".kit[3:9]"  3 9 9 9 9 9 9;
	setAttr -s 10 ".kot[3:9]"  3 9 9 9 9 9 9;
createNode animCurveTA -n "IMP_Head_rotateX";
	...
	setAttr -s 10 ".ktv[0:9]"  1 -10.120831904257262 6.6 -1.3642999981520949 
		11.4 -16.862715915252902 13 -16.154270916852411 16 -16.154270916852411 27 
		-8.6238431128618682 33 -8.6238431128618682 39 -18.553074155080996 47 -16.154270916852411 
		52 -16.154270916852411;
	setAttr -s 10 ".kit[3:9]"  3 9 9 9 9 9 9;
	setAttr -s 10 ".kot[3:9]"  3 9 9 9 9 9 9;
createNode animCurveTL -n "IMP_Head_translateY";
	...
	setAttr -s 10 ".ktv[0:9]"  1 2.6456615572060826 6.6 2.6456615572060826 
		11.4 2.6456615572060826 13 2.6456615572060826 16 2.6456615572060826 27 2.6456615572060826 
		33 2.6456615572060826 39 2.6456615572060826 47 2.6456615572060826 52 2.6456615572060826;
	setAttr -s 10 ".kit[3:9]"  3 9 9 9 9 9 9;
	setAttr -s 10 ".kot[3:9]"  3 9 9 9 9 9 9;
createNode animCurveTL -n "IMP_Head_translateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  1 1.9935618776130362 6.6 1.9935618776130362 
		11.4 1.9935618776130362 13 1.9935618776130362 16 1.9935618776130362 27 1.9935618776130362 
		33 1.9935618776130362 39 1.9935618776130362 47 1.9935618776130362 52 1.9935618776130362;
	setAttr -s 10 ".kit[3:9]"  3 9 9 9 9 9 9;
	setAttr -s 10 ".kot[3:9]"  3 9 9 9 9 9 9;
createNode animCurveTL -n "IMP_Head_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  1 0 6.6 0 11.4 0 13 0 16 0 27 0 
		33 0 39 0 47 0 52 0;
	setAttr -s 10 ".kit[3:9]"  3 9 9 9 9 9 9;
	setAttr -s 10 ".kot[3:9]"  3 9 9 9 9 9 9;
...
createNode animCurveTU -n "IMP_Lloarm_scaleX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 13 1 16 1;
...
createNode animCurveTL -n "IMP_Lloarm_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 12.412879749935719 13 12.412879749935719 
		16 12.412879749935719;
	setAttr -s 3 ".kit[1:2]"  3 9;
	setAttr -s 3 ".kot[1:2]"  3 9;
createNode animCurveTL -n "IMP_Lloarm_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -6.7286993982861674 13 -6.7286993982861674 
		16 -6.7286993982861674;
	setAttr -s 3 ".kit[1:2]"  3 9;
	setAttr -s 3 ".kot[1:2]"  3 9;
createNode animCurveTL -n "IMP_Lloarm_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -3.868763862603668 13 -3.868763862603668 
		16 -3.868763862603668;
	setAttr -s 3 ".kit[1:2]"  3 9;
	setAttr -s 3 ".kot[1:2]"  3 9;
createNode animCurveTA -n "IMP_Lloarm_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 80.239686562403847 13 80.239686562403847 
		16 54.077927468358183;
	setAttr -s 3 ".kit[1:2]"  3 9;
	setAttr -s 3 ".kot[1:2]"  3 9;
createNode animCurveTA -n "IMP_Lloarm_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 5.8978517871634404 13 5.8978517871634404 
		16 5.8978517871634288;
	setAttr -s 3 ".kit[1:2]"  3 9;
	setAttr -s 3 ".kot[1:2]"  3 9;
createNode animCurveTA -n "IMP_Lloarm_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0.92545182592768849 13 0.92545182592768849 
		16 0.92545182592768971;
	setAttr -s 3 ".kit[1:2]"  3 9;
	setAttr -s 3 ".kot[1:2]"  3 9;
...
createNode animCurveTU -n "IMP_Rloarm_scaleX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1 10.6 1 13 1 16 1 33 1 52 1;
...
createNode animCurveTL -n "IMP_Rloarm_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -12.41287000000041 10.6 -12.41287000000041 
		13 -12.41287000000041 16 -12.41287000000041 33 -12.41287000000041 52 -12.41287000000041;
	setAttr -s 6 ".kit[2:5]"  3 9 3 3;
	setAttr -s 6 ".kot[2:5]"  3 9 3 3;
createNode animCurveTL -n "IMP_Rloarm_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -6.7285999999993047 10.6 -6.7285999999993047 
		13 -6.7285999999993047 16 -6.7285999999993047 33 -6.7285999999993047 52 -6.7285999999993047;
	setAttr -s 6 ".kit[2:5]"  3 9 3 3;
	setAttr -s 6 ".kot[2:5]"  3 9 3 3;
createNode animCurveTL -n "IMP_Rloarm_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -3.8687599999999316 10.6 -3.8687599999999316 
		13 -3.8687599999999316 16 -3.8687599999999316 33 -3.8687599999999316 52 -3.8687599999999316;
	setAttr -s 6 ".kit[2:5]"  3 9 3 3;
	setAttr -s 6 ".kot[2:5]"  3 9 3 3;
createNode animCurveTA -n "IMP_Rloarm_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 58.099612817676174 10.6 82.316033184538099 
		13 82.316033184538099 16 64.08197397813943 33 55.854205132375412 52 64.08197397813943;
	setAttr -s 6 ".kit[2:5]"  3 9 3 3;
	setAttr -s 6 ".kot[2:5]"  3 9 3 3;
createNode animCurveTA -n "IMP_Rloarm_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 10.6 0 13 0 16 0 33 -3.8931075435917726 
		52 0;
	setAttr -s 6 ".kit[2:5]"  3 9 3 3;
	setAttr -s 6 ".kot[2:5]"  3 9 3 3;
createNode animCurveTA -n "IMP_Rloarm_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 10.6 0 13 0 16 0 33 2.6364787994799905 
		52 0;
	setAttr -s 6 ".kit[2:5]"  3 9 3 3;
	setAttr -s 6 ".kot[2:5]"  3 9 3 3;
...
createNode animCurveTU -n "IMP_Ruparm_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 1 16 1 38 1 52 1;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTA -n "IMP_Ruparm_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 -5.8807954640291324 16 8.5156304394485858 
		38 -6.5226954304651867 52 8.5156304394485858;
	setAttr -s 4 ".kit[0:3]"  3 9 9 9;
	setAttr -s 4 ".kot[0:3]"  3 9 9 9;
createNode animCurveTA -n "IMP_Ruparm_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 -3.4977373448908193 16 -41.436655454713687 
		38 -31.871418013889308 52 -41.436655454713687;
	setAttr -s 4 ".kit[0:3]"  3 9 9 9;
	setAttr -s 4 ".kot[0:3]"  3 9 9 9;
createNode animCurveTA -n "IMP_Ruparm_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 22.979007009556593 16 16.360110645449957 
		38 10.871775215957863 52 16.360110645449957;
	setAttr -s 4 ".kit[0:3]"  3 9 9 9;
	setAttr -s 4 ".kot[0:3]"  3 9 9 9;
createNode animCurveTL -n "IMP_Ruparm_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 -3.0821100000000254 16 -3.0821100000000254 
		38 -5.5605251191758986 52 -3.0821100000000254;
	setAttr -s 4 ".kit[0:3]"  3 9 9 9;
	setAttr -s 4 ".kot[0:3]"  3 9 9 9;
createNode animCurveTL -n "IMP_Ruparm_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 2.1192000000001707 16 2.1192000000001707 
		38 2.4447726192235173 52 2.1192000000001707;
	setAttr -s 4 ".kit[0:3]"  3 9 9 9;
	setAttr -s 4 ".kot[0:3]"  3 9 9 9;
createNode animCurveTL -n "IMP_Ruparm_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 -3.3867499999998705 16 -3.3867499999998705 
...
createNode animCurveTL -n "IMP_Luparm_translateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 3.3867545965885748 16 3.3867545965885748 
		38 3.6273380960601238 52 3.3867545965885748;
	setAttr -s 4 ".kit[2:3]"  9 3;
	setAttr -s 4 ".kot[2:3]"  9 3;
createNode animCurveTL -n "IMP_Luparm_translateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 2.1192573708760349 16 2.1192573708760349 
		38 3.1840952748737745 52 2.1192573708760349;
	setAttr -s 4 ".kit[2:3]"  9 3;
	setAttr -s 4 ".kot[2:3]"  9 3;
createNode animCurveTL -n "IMP_Luparm_translateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 -3.0821078932592165 16 -3.0821078932592165 
		38 -3.6260434114653686 52 -3.0821078932592165;
	setAttr -s 4 ".kit[2:3]"  9 3;
	setAttr -s 4 ".kot[2:3]"  9 3;
createNode animCurveTA -n "IMP_Luparm_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 0 16 75.312657822261826 38 64.674867284673837 
...
createNode animCurveTA -n "IMP_Luparm_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 0 16 11.771191120276887 38 4.2143403133580959 
...
createNode animCurveTA -n "IMP_Luparm_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  13 -6.7129388973255946 16 14.730782984337566 
		38 14.346670463919063 52 14.730782984337566;
	setAttr -s 4 ".kit[2:3]"  9 3;
	setAttr -s 4 ".kot[2:3]"  9 3;
...
createNode animCurveTU -n "IMP_RHAND_ROT_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 1 26 1 38 1 52 1;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTL -n "IMP_RHAND_ROT_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 -7.5406347832540632e-013 26 
		-7.5406347832540632e-013 38 -7.5406347832540632e-013 52 -7.5406347832540632e-013;
createNode animCurveTL -n "IMP_RHAND_ROT_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 13.71946295727715 26 13.71946295727715 
		38 13.71946295727715 52 13.71946295727715;
createNode animCurveTL -n "IMP_RHAND_ROT_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 -3.0908609005564358e-013 26 
		-3.0908609005564358e-013 38 -3.0908609005564358e-013 52 -3.0908609005564358e-013;
createNode animCurveTA -n "IMP_RHAND_ROT_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 260.01204204600725 26 267.95782566597035 
		38 274.18651268285799 52 260.01204204600725;
createNode animCurveTA -n "IMP_RHAND_ROT_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 -38.320908201910434 26 -44.615662638752354 
		38 -46.770294375075956 52 -38.320908201910434;
createNode animCurveTA -n "IMP_RHAND_ROT_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 -322.65738741293052 26 -344.40785024388987 
		38 -359.71482733769528 52 -322.65738741293052;
createNode animCurveTU -n "IMP_RHAND_ROT_scaleX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 15.445123296459183 26 15.445123296459183 
		38 15.445123296459183 52 15.445123296459183;
createNode animCurveTU -n "IMP_RHAND_ROT_scaleY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 15.445123296459185 26 15.445123296459185 
		38 15.445123296459185 52 15.445123296459185;
createNode animCurveTU -n "IMP_RHAND_ROT_scaleZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 15.445123296459181 26 15.445123296459181 
		38 15.445123296459181 52 15.445123296459181;
createNode animCurveTU -n "IMP_RHAND_ROT_IK";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 0 26 0 38 0 52 0;
createNode animCurveTU -n "IMP_RHAND_ROT_FIST";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 0.70000000000000007 26 0.70000000000000007 
		38 0.70000000000000007 52 0.70000000000000007;
...
createNode animCurveTL -n "IMP_Rheel_translateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 -6.6987428689401023;
createNode animCurveTL -n "IMP_Rheel_translateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 -1.0063285154727897;
createNode animCurveTL -n "IMP_Rheel_translateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 3.9024574139229289;
...
createNode animCurveTA -n "IMP_Rheel_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 17.856773962630957;
createNode animCurveTA -n "IMP_Rheel_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 -36.171253008403404;
createNode animCurveTA -n "IMP_Rheel_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 -10.870404993254283;
...
createNode animCurveTL -n "IMP_Lheel_translateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 9.6873596619451892;
createNode animCurveTL -n "IMP_Lheel_translateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 0.098625839244114;
createNode animCurveTL -n "IMP_Lheel_translateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 14.651463035095317;
...
createNode animCurveTA -n "IMP_Lheel_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 4.9130999348608286;
createNode animCurveTA -n "IMP_Lheel_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 35.947765167312816;
createNode animCurveTA -n "IMP_Lheel_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  16 8.3268568844740365;
...
createNode animCurveTL -n "IMP_Body_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 1.9225081589985762 33 2.1568928123229139 
		44 1.9994727977102094 52 1.9225081589985762;
	setAttr -s 4 ".kit[0:3]"  3 9 9 3;
	setAttr -s 4 ".kot[0:3]"  3 9 9 3;
createNode animCurveTL -n "IMP_Body_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 35.652019839492347 33 35.665436407542778 
		44 35.826315836278539 52 35.652019839492347;
	setAttr -s 4 ".kit[0:3]"  3 9 9 3;
	setAttr -s 4 ".kot[0:3]"  3 9 9 3;
createNode animCurveTL -n "IMP_Body_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 13.461907599494868 33 12.482060965090039 
		44 12.753457266829548 52 13.461907599494868;
	setAttr -s 4 ".kit[0:3]"  3 9 9 3;
	setAttr -s 4 ".kot[0:3]"  3 9 9 3;
createNode animCurveTU -n "IMP_Body_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 1 33 1 44 1 52 1;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTA -n "IMP_Body_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 0.64576725303311566 33 -8.8710685572569332 
		44 -0.081081151691383815 52 0.64576725303311566;
	setAttr -s 4 ".kit[0:3]"  3 9 9 3;
	setAttr -s 4 ".kot[0:3]"  3 9 9 3;
createNode animCurveTA -n "IMP_Body_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 0 33 -0.062604275251697108 44 
		-0.14343447938809131 52 0;
	setAttr -s 4 ".kit[0:3]"  3 9 9 3;
	setAttr -s 4 ".kot[0:3]"  3 9 9 3;
createNode animCurveTA -n "IMP_Body_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  16 0.47460937865742331 33 0.51311428136126047 
		44 0.49774443957308534 52 0.47460937865742331;
	setAttr -s 4 ".kit[0:3]"  3 9 9 3;
	setAttr -s 4 ".kot[0:3]"  3 9 9 3;
...
createNode animCurveTA -n "IMP_LIK_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 -97.8430816148296 36 -106.27988485531623 
		52 -97.8430816148296;
createNode animCurveTA -n "IMP_LIK_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 2.1461068188508792 36 26.539231153496413 
		52 2.1461068188508792;
createNode animCurveTA -n "IMP_LIK_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 -85.383790866488482 36 -73.676118255829095 
		52 -85.383790866488482;
createNode animCurveTU -n "IMP_LIK_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 1 36 1 52 1;
...
createNode animCurveTU -n "IMP_LIK_poleVectorX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 0 36 0 52 0;
...
createNode animCurveTA -n "IMP_RIK_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 -81.042166485265085 34 -78.53075522190322 
		52 -81.042166485265085;
createNode animCurveTA -n "IMP_RIK_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 53.942839579097168 34 51.95495813660505 
		52 53.942839579097168;
createNode animCurveTA -n "IMP_RIK_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 -93.582844077068899 34 -90.69018765638441 
		52 -93.582844077068899;
createNode animCurveTU -n "IMP_RIK_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 1 34 1 52 1;
	setAttr -s 3 ".kot[0:2]"  5 5 5;
...
createNode animCurveTU -n "IMP_RIK_poleVectorX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  16 0 34 0 52 0;
...
select -ne IMP_Rball;
	...
	setAttr ".r" -type "double3" -17.499757121316115 3.2695897469829736 -6.9162979482121418 ;
